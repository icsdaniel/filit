...
class PointsSlider2 extends StatefulWidget {
  PointsSlider2(
      {Key? key,
      this.blockHeight = 50,
      this.barHeight = 660,
  ...
  @override
  _PointsSlider2State createState() => _PointsSlider2State();
}

class _PointsSlider2State extends State<PointsSlider2> {
  int _points = 0;
  double _value = 0;
  double _toShow = 0.0;
...
@override
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      CloseButton(onPressed: _showScore)
    ]);
  }
}